...
class TurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post turnos_url, params: { turno: { capacidad: @turno.capacidad, conductor: @turno.conductor, fecha: @turno.fecha, hora: @turno.hora, trayecto: @turno.trayecto } }
    end
  ...
  test "should update turno" do
    patch turno_url(@turno), params: { turno: { capacidad: @turno.capacidad, conductor: @turno.conductor, fecha: @turno.fecha, hora: @turno.hora, trayecto: @turno.trayecto } }
